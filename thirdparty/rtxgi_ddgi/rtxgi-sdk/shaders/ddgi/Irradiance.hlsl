...
struct DDGIVolumeResources
{
    ...
    Texture2DArray<uint> probeValidity;
};
    ...
    out float support)
{
    ...
    for(int probeIndex = 0; probeIndex < 8; probeIndex++)
    {
        ...
        if (resources.probeValidity.Load(int4(DDGIGetProbeTexelCoords(adjacentProbeIndex, volume), 0)) == 0u) continue;
