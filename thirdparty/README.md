...
- Upstream: https://github.com/NVIDIA-RTX/NRD
- Version: 4.17.1 (2cd553031abec76bc4e109f20ef40a23ef0645c7, 2026)
- License: NVIDIA RTX SDKs License
- Build dependencies:
  - ShaderMake 18f5a344e7ca8fa65daaf079d07bc8ce38453e05, MIT
  - MathLib v11 (974e1387ba936740c7cdc494792d2641bc127e86), MIT
  - DirectX Shader Compiler v1.8.2505 selected by the pinned ShaderMake recipe

Files extracted from upstream source:

- `Include/`, `Source/` and `Shaders/`
- `Resources/Version.h`
- MathLib headers and ShaderMake's `ShaderBlob` host source under `Dependencies/`
- Separate upstream licenses for NRD, MathLib and ShaderMake

`_Shaders/*.spirv.h` is generated by the pinned NRD CMake and ShaderMake recipe
with `NRD_STATIC_LIBRARY=ON`, SPIR-V enabled, and DXBC/DXIL disabled. Run
`python misc/scripts/update_rtxdi_nrd.py` to reproduce the import.
...
- Upstream: https://github.com/NVIDIA-RTX/RTXDI-Library
- Version: 3.1 (f12037fa8e97ebc08e9e3edfd2de528ed1772a4b, 2026)
- License: NVIDIA RTX SDKs License
...
Run `python misc/scripts/update_rtxdi_nrd.py` to reproduce the import.
